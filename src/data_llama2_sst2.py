...
from my_utils.data_process_cl import sample_data_sst2,cat_demo
...
demo_sample,val_sample,test_sample = sample_data_sst2(dataset = dataset['train'],actual_sample_size = 4000, demo_size = demo_per_shot,seed = 49)
eval_data = cat_demo(demo_sample,val_sample,task_name,demo_per_shot*2)
test_data = cat_demo(demo_sample,test_sample,task_name,demo_per_shot*2)
